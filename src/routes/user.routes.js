...
const { getProfile, updateProfile, createTeacher, getTeachers, getTeacherById, updateTeacher, deleteTeacher, createStudent, getStudents, getStudentById, updateStudent, deleteStudent, viewLesson, viewVocabulary, getStudentLearningProgress } = require("../controllers/user.controller");
...
router.get("/students/progress/learning", authRequired, getStudentLearningProgress);
